...
def _copy_tree(src: str, dst: str, ignore_dirs: set[str]) -> dict:
  copied = 0
  skipped = 0
...
def _ensure_root_index(staging_dir: str, fallback_from_dir: str | None) -> bool:
...
def main() -> int:
  ...
  ignore_dirs = {".git", "node_modules", ".vercel", "__pycache__"}
