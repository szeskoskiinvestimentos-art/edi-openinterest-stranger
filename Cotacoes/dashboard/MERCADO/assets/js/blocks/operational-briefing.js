        ...
        try {
            ...
            const bindRange = (id, group, key) => {
                ...
                el.addEventListener('input', () => {
                    ...
                    persist();
                    if (typeof renderOperationalBriefing === 'function') renderOperationalBriefing();
                    if (typeof renderBtcOperationalBriefing === 'function') renderBtcOperationalBriefing();
                    if (typeof renderHk50OperationalBriefing === 'function') renderHk50OperationalBriefing();
                });
            };
