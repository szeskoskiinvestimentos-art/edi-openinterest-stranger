(function () {
    ...
    function render({ data, el, deps } = {}) {
        ...
        const math = (d && d.regimeConvictionMath) ? d.regimeConvictionMath : (w.regimeConvictionMath || {});
        const downgradeConvictionLabel = typeof math.downgradeConvictionLabel === 'function'
            ? math.downgradeConvictionLabel
            : ((label, steps) => {
        ...
        const buildReturnSeries = (symbol, maxPoints) => (typeof math.buildReturnSeries === 'function' ? math.buildReturnSeries(data, symbol, maxPoints) : []);
        const correlationAligned = typeof math.correlationAligned === 'function' ? math.correlationAligned : (() => ({ corr: null, n: 0 }));
        ...
        const weightedAvg = typeof math.weightedAvg === 'function' ? math.weightedAvg : (() => null);
