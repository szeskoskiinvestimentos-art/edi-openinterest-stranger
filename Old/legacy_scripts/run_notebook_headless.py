...
def get_ipython():
    return type('MockIPython', (object,), {
        'run_line_magic': lambda self, *args: None,
        'system': lambda self, *args: None
    })()
...
fig.update_layout(template='plotly_dark', barmode='overlay', xaxis_title='Strike', yaxis_title='Exposição / OI', xaxis=dict(range=[SPOT-300, SPOT+300], tickmode='auto'), legend=dict(orientation='h', yanchor='bottom', y=1.02, xanchor='left', x=0.0), margin=dict(t=100))
...
buttons = [
    ...
    dict(label='Vanna Exposure', method='update', args=[{'visible':[False, False, False, False, False, False, False, False, False, True, False, False, False, False, False]}, {'title':'USD/BRL — Vanna Exposure por Strike', 'shapes':[spot_line, hline0], 'annotations':[infobox(), spot_label]}]),
    ...
    if 'fig3' in globals():
        ...
        if traces:
            ...
            fig_sub.update_layout(
                ...
                title=dict(text='Delta Agregado', font=dict(color='white', size=18), x=0.5),
                xaxis_title='Strike',
                yaxis_title='Valor',
...
try:
    if 'fig3' in globals():
        ...
        if traces:
            ...
            fig_sub.update_layout(
                template='plotly_dark',
                title=dict(text='Delta Acumulado', font=dict(color='white', size=18), x=0.5),
                xaxis_title='Strike',
                yaxis_title='Valor',
                shapes=common_shapes,
                annotations=common_annos,
...
try:
    if 'fig3' in globals():
        ...
        if traces:
            ...
            fig_sub.update_layout(
                template='plotly_dark',
                title=dict(text='Gamma Exposure (GEX)', font=dict(color='white', size=18), x=0.5),
                xaxis_title='Strike',
                yaxis_title='Valor',
                shapes=common_shapes,
                annotations=common_annos,
...
try:
    if 'fig3' in globals():
        ...
        if traces:
            ...
            fig_sub.update_layout(
                template='plotly_dark',
                title=dict(text='Gamma Exposure (OI)', font=dict(color='white', size=18), x=0.5),
                xaxis_title='Strike',
                yaxis_title='Valor',
                shapes=common_shapes,
                annotations=common_annos,
...
try:
    if 'fig3' in globals():
        ...
        if traces:
            ...
            fig_sub.update_layout(
                template='plotly_dark',
                title=dict(text='Gamma Exposure (IV)', font=dict(color='white', size=18), x=0.5),
                xaxis_title='Strike',
                yaxis_title='Valor',
                shapes=common_shapes,
                annotations=common_annos,
...
try:
    if 'fig3' in globals():
        ...
        if traces:
            ...
            fig_sub.update_layout(
                template='plotly_dark',
                title=dict(text='R Gamma (PVOP)', font=dict(color='white', size=18), x=0.5),
                xaxis_title='Strike',
                yaxis_title='Valor',
                shapes=common_shapes,
                annotations=common_annos,
...
try:
    if 'fig3' in globals():
        ...
        if traces:
            ...
            fig_sub.update_layout(
                template='plotly_dark',
                title=dict(text='Open Interest por Strike', font=dict(color='white', size=18), x=0.5),
                xaxis_title='Strike',
                yaxis_title='Valor',
                shapes=common_shapes,
                annotations=common_annos,
...
try:
    if 'fig3' in globals():
        ...
        if traces:
            ...
            fig_sub.update_layout(
                template='plotly_dark',
                title=dict(text='Charm Exposure', font=dict(color='white', size=18), x=0.5),
                xaxis_title='Strike',
                yaxis_title='Valor',
                shapes=common_shapes,
                annotations=common_annos,
...
try:
    if 'fig3' in globals():
        ...
        if traces:
            ...
            fig_sub.update_layout(
                template='plotly_dark',
                title=dict(text='Vanna Exposure', font=dict(color='white', size=18), x=0.5),
                xaxis_title='Strike',
                yaxis_title='Valor',
                shapes=common_shapes,
                annotations=common_annos,
...
try:
    if 'fig3' in globals():
        ...
        if traces:
            ...
            fig_sub.update_layout(
                template='plotly_dark',
                title=dict(text='Visão Completa', font=dict(color='white', size=18), x=0.5),
                xaxis_title='Strike',
                yaxis_title='Valor',
                shapes=common_shapes,
                annotations=common_annos,
...
def _save_panel_ext(fig, filename, title, help_key=None):
    ...
    try:
        ...
        pass # fig_thumb.write_image(f'exports/{filename}.svg', width=300, height=160) # DISABLED IMAGE EXPORT
    except Exception as e:
...
for mode_file, mode_title, help_key in _modes:
    ...
    try:
        ...
        pass # fig_m.write_image(os.path.join(print_dir, f"{mode_file}.svg"), width=1920, height=1080, scale=2) # DISABLED IMAGE EXPORT
    except Exception as e:
...
os.makedirs('exports', exist_ok=True)
try:
    pass # fig3.write_image('exports/Figura3.svg', format='svg', scale=2, width=1400, height=650) # DISABLED IMAGE EXPORT
    pass # fig4.write_image('exports/Figura4.svg', format='svg', scale=2, width=1400, height=650) # DISABLED IMAGE EXPORT
    pass # fig_flow.write_image('exports/Fluxo_Hedge.svg', format='svg', scale=2, width=1200, height=600) # DISABLED IMAGE EXPORT
    pass # fig_dp.write_image('exports/Dealer_Pressure.svg', format='svg', scale=2, width=1200, height=600) # DISABLED IMAGE EXPORT
    pass # fig_cone.write_image('exports/Gamma_Flip_Cone.svg', format='svg', scale=2, width=1200, height=600) # DISABLED IMAGE EXPORT
    pass # fig_charm.write_image('exports/Charm_Flow.svg', format='svg', scale=2, width=1200, height=600) # DISABLED IMAGE EXPORT
    pass # fig_vanna.write_image('exports/Vanna_Sensitivity.svg', format='svg', scale=2, width=1200, height=600) # DISABLED IMAGE EXPORT
    pass # fig_pin.write_image('exports/Pin_Risk.svg', format='svg', scale=2, width=1200, height=600) # DISABLED IMAGE EXPORT
    pass # fig_rails.write_image('exports/Rails_Bounce.svg', format='svg', scale=2, width=1200, height=600) # DISABLED IMAGE EXPORT
    pass # fig_exp.write_image('exports/Expiry_Pressure.svg', format='svg', scale=2, width=1200, height=600) # DISABLED IMAGE EXPORT
    pass # fig_expo.write_image('exports/Gamma_Exposure_Curve.svg', format='svg', scale=2, width=1200, height=600) # DISABLED IMAGE EXPORT
except Exception as e:
...
# index_html writing disabled to avoid conflict with build_dashboard_v2.py
...
try:
    pass # fig3.write_image('exports/Painel_Delta_GEX.svg', format='svg', width=1400, height=650) # DISABLED IMAGE EXPORT
    pass # fig4.write_image('exports/GEX_Gamma_Flip.svg', format='svg', width=1400, height=650) # DISABLED IMAGE EXPORT
    pass # fig_flow.write_image('exports/Fluxo_Hedge.svg', format='svg', width=1200, height=600) # DISABLED IMAGE EXPORT
    pass # fig_dp.write_image('exports/Dealer_Pressure.svg', format='svg', width=1200, height=600) # DISABLED IMAGE EXPORT
    pass # fig_cone.write_image('exports/Gamma_Flip_Cone.svg', format='svg', width=1200, height=600) # DISABLED IMAGE EXPORT
    pass # fig_charm.write_image('exports/Charm_Flow.svg', format='svg', width=1200, height=600) # DISABLED IMAGE EXPORT
    pass # fig_vanna.write_image('exports/Vanna_Sensitivity.svg', format='svg', width=1200, height=600) # DISABLED IMAGE EXPORT
    pass # fig_pin.write_image('exports/Pin_Risk.svg', format='svg', width=1200, height=600) # DISABLED IMAGE EXPORT
    pass # fig_rails.write_image('exports/Rails_Bounce.svg', format='svg', width=1200, height=600) # DISABLED IMAGE EXPORT
    pass # fig_exp.write_image('exports/Expiry_Pressure.svg', format='svg', width=1200, height=600) # DISABLED IMAGE EXPORT
except Exception as e:
    pass
